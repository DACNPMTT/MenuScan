        ...
        if scan.menu is not None:
            ...
            if dining_session is not None:
                ...
                if rec_ids:
                    ...
                    for bd in breakdowns:
                        d_name = p_map.get(bd.participant_id, "Thành viên")
                        bd_data = ParticipantBreakdownResponse(
                            display_name=d_name,
                            verdict=bd.verdict.value,
                            score=float(bd.score) if bd.score is not None else None,
            ...
            for item in paged_items:
                ...
                if dining_session is not None:
                    ...
                    if r is not None:
                        rec_data = RecommendationResponse(
                ...
                items_response.append(
                    MenuItemData.model_validate(item).model_copy(
